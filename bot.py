...
def start_msg(message):
    ...
    bot.send_message(message.chat.id,
                     f"🎵 ¡Hola {saludo}! Soy MelodIAn tu asistente de Musicoterapia.\n"
...
def callback_query(call):
    ...
    if call.data in EMOCIONES:
        ...
        markup.add(*btns)
        bot.send_message(call.message.chat.id, "¡Perfecto! Ahora selecciona el tipo de música que te gusta:", reply_markup=markup)
